...
def fitness(start_cell: tuple[int, int], individual: list[int], end_cell: tuple[int, int], grid: np.ndarray) -> tuple[int, int]:
    ...
    """
    path = parse_chromosome(start_cell, end_cell, individual, grid)
...
def parse_chromosome(start_cell: tuple[int, int], end_cell: tuple[int, int], chromosome: list[int], grid: np.ndarray) -> list[tuple[int, int]]:
...
def solve_labyrinth(grid: np.ndarray, start_cell: tuple, end_cell: tuple, max_time_s: float) -> list[tuple[int, int]]:
    ...
    return parse_chromosome(start_cell, end_cell, best, grid) 
